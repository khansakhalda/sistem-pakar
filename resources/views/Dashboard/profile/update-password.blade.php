...
<div class="pd-20 card-box mb-30" style="margin-top: -1.2rem">
    <div class="clearfix mb-20">
        <div class="pull-left">
            <h4 class="text-black h4" style="color: #0d6efd;">Perbarui Password</h4>
            <p class="text-secondary" style="margin-top: -0.5rem">
                <small>Silakan isi formulir di bawah ini untuk memperbarui kata sandi Anda.</small>
            </p>
        </div>
    </div>
    ...
    <form action="{{ route('password.update') }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" name="current_password" placeholder="Masukkan password lama">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" name="password_confirmation" placeholder="Masukkan password baru anda lagi">
