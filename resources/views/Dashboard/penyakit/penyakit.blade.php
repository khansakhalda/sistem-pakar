...
<div class="page-header">
    <div class="row">
        <div class="col-md-12">
            <div class="title">
                <h4 class="fw-bold" style="color: #0d6efd;">Kelola Data Penyakit</h4>
            </div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-white px-3 py-2 shadow-sm rounded">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Beranda</a></li>
                    <li class="breadcrumb-item active" style="color: #0d6efd;" aria-current="page">Penyakit</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="card-box pd-20 mb-5 mt-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-semibold" style="color: #0d6efd;">Daftar Penyakit</h5>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #0d6efd;">
                <h5 class="modal-title fw-bold text-white">Detail Penyakit: {{ $penyakit->nama_penyakit }}</h5>
                <button type="button" class="btn text-white border-0" data-bs-dismiss="modal"
                        aria-label="Tutup" style="font-size: 1.8rem; line-height: 1;">
