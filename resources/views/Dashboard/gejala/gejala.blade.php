...
<div class="page-header">
    <div class="row">
        <div class="col-md-12">
            <div class="title">
                <h4 class="fw-bold" style="color: #0d6efd;">Kelola Data Gejala</h4>
            </div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-white px-3 py-2 shadow-sm rounded">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Beranda</a></li>
                    <li class="breadcrumb-item active" style="color: #0d6efd;" aria-current="page">Gejala</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="card-box pd-20 mb-30 mt-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-semibold" style="color: #0d6efd;">Daftar Gejala</h5>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('gejala.store') }}" method="POST">
                @csrf
                <div class="modal-header text-white" style="background-color: #0d6efd;">
                    <h5 class="modal-title fw-bold text-white">Tambah Gejala</h5>
                    <button type="button" class="btn text-white border-0" data-bs-dismiss="modal" aria-label="Tutup" style="font-size: 1.5rem;">
                        <i class="bi bi-x-lg"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_gejala" id="nama_gejala" class="form-control" placeholder="Contoh: Mual, Demam, Lemas, dll">
                    </div>
                </div>
                <div class="modal-footer">
